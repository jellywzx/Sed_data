...
def process_shashi_jianli():
    ...
    for station_id, station_info in stations.items():
        ...
        ds.attrs = {
            ...
            'references': 'Nones, M., Guo, C. (2025). Remote sensing as a support tool to map suspended sediment concentration over extended river reaches. Acta Geophysica, 73:4655-4668. https://doi.org/10.1007/s11600-025-01638-x',
