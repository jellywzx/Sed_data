...
> `main` is the authoritative working branch. It may retain server-specific defaults used for ongoing reproduction; portable overrides are documented below where supported.
